                        ...
                        <ul class="list-unstyled p-0 m-0">
                            ...
                            <li class="side-a">
                                <a href="../main_web/Sorting-Visualization/index.html"
                                    class="text-white text-decoration-none">Algo-Visualizer</a>
                            </li>
                            <li class="side-a">
                                <a href="../main_web/quiz/index.html" class="text-white text-decoration-none">Quiz</a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card mb-3" style="max-width: 540px">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="../assets/code.png" class="img-fluid rounded-start" alt="..." />
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="card mb-3" style="max-width: 540px">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="../assets/web.jpg" class="img-fluid rounded-start" alt="..." />
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card" style="max-width: 540px">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="../assets/algo.png" class="img-fluid rounded-start" alt="..." />
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="card" style="max-width: 540px">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="../assets/Quiz.jpg" class="img-fluid rounded-start" alt="..." />
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
